    ...
    return AlgorithmReel(
        ...
        steps=[
            ...
            step(3, "if nums[mid] < target:  # 12 < 23",
                 ...
                 array(values, eliminated=[0, 1, 2, 3], labels={0: "lo", 3: "mid", 7: "hi"},
                       caption="12 < 23 → everything up to mid is out"),
                 lines=[7]),
            step(4, "lo = mid + 1",
    ...
    return AlgorithmReel(
        ...
        steps=[
            ...
            step(4, "# third pair",
                 ...
                 "Third pair, c and c, and they match as well. Notice what we have not done. There is no reversed copy of the string anywhere in memory. We have checked six characters while storing nothing but two position numbers, no matter how long the input gets.",
